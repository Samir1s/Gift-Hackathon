...
const ShimmerButton = ({ children, className, href, ...props }) => {
    return (
        <a
            href={href || "#"}
            className={cn(
                "group relative inline-flex h-11 items-center justify-center overflow-hidden rounded-full bg-slate-950 px-8 font-medium text-slate-300 transition-all hover:text-white hover:scale-105 active:scale-95 duration-300",
                className
            )}
            {...props}
        >
