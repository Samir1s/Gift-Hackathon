...
import { Mail, Lock, Eye, EyeOff, ArrowRight, TrendingUp, User } from 'lucide-react';
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // If backend is offline, just navigate anyway for demo
    ...
    return (
        <div className="min-h-screen bg-[#0F1117] flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                {error && (
                    <div className="mb-4 p-3 rounded-xl bg-[#FF4D6D]/10 border border-[#FF4D6D]/20 text-[#FF4D6D] text-sm text-center">
                        {error}
                    </div>
                )}
                ...
                <button
                    ...
                    className="w-full h-12 rounded-xl bg-[#1C1F2E] border border-white/[0.06] text-white font-medium flex items-center justify-center gap-3 hover:bg-[#1C1F2E]/80 hover:border-[#7B3FE4]/20 transition-all cursor-pointer btn-press mb-6"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button type="submit" disabled={loading}
                        className="w-full h-12 rounded-xl gradient-primary text-white font-semibold flex items-center justify-center gap-2 shadow-[0_4px_20px_rgba(123,63,228,0.3)] hover:shadow-[0_4px_30px_rgba(123,63,228,0.45)] transition-all btn-press cursor-pointer disabled:opacity-60">
                        {loading ? (
